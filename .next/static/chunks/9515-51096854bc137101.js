 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let z=new Map;function V(e,t){let n=H(e);W(n,t),function(e,t){let n=(!q&&"BroadcastChannel"in self&&((q=new BroadcastChannel("[Firebase] FID Change")).onmessage=e=>{W(e.data.key,e.data.fid)}),q);n&&n.postMessage({key:e,fid:t}),0===z.size&&q&&(q.close(),q=null)}(n,t)}function W(e,t){let n=z.get(e);if(n)for(let e of n)e(t)}let q=null,U="firebase-installations-store",K=null;function Z(){return K||(K=function(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){let o=indexedDB.open(e,1),s=I(o);return r&&o.addEventListener("upgradeneeded",e=>{r(I(o.result),e.oldVersion,e.newVersion,I(o.transaction))}),n&&o.addEventListener("blocked",()=>n()),s.then(e=>{a&&e.addEventListener("close",()=>a()),i&&e.addEventListener("versionchange",()=>i())}).catch(()=>{}),s}("firebase-installations-database",0,{upgrade:(e,t)=>{0===t&&e.createObjectStore(U)}})),K}async function G(e,t){let n=H(e),r=await Z(),i=r.transaction(U,"readwrite"),a=i.objectStore(U),o=await a.get(n);return await a.put(t,n),await i.done,o&&o.fid===t.fid||V(e,t.fid),t}async function X(e){let t=H(e),n=await Z(),r=n.transaction(U,"readwrite");await r.objectStore(U).delete(t),await r.done}async function J(e,t){let n=H(e),r=await Z(),i=r.transaction(U,"readwrite"),a=i.objectStore(U),o=await a.get(n),s=t(o);return void 0===s?await a.delete(n):await a.put(s,n),await i.done,s&&(!o||o.fid!==s.fid)&&V(e,s.fid),s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eu(e,t=!1){await ed(e);let n=await ei(e,t);return n.token}async function ed(e){let{registrationPromise:t}=await Y(e);t&&await t}function eh(e){return O.create("missing-app-config-values",{valueName:e})}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eB{constructor(e){this.app=e}_delete(){return delete eO[this.app.options.appId],Promise.resolve()}}let eO={},ek=[],eM={},eN="dataLayer",e$=!1;function ej(e=(0,u.Mq)()){e=(0,h.m9)(e);let t=(0,u.qX)(e,ep);return t.isInitialized()?t.getImmediate():function(e,t={}){let n=(0,u.qX)(e,ep);if(n.isInitialized()){let e=n.getImmediate();if((0,h.vZ)(t,n.getOptions()))return e;throw eb.create("already-initialized")}let r=n.initialize({options:t});return r}(e)}async function eP(){if((0,h.ru)()||!(0,h.zI)()||!(0,h.hl)())return!1;try{let e=await (0,h.eu)();return e}catch(e){return!1}}function ex(e,t,n,r){eT(l,eO[(e=(0,h.m9)(e)).app.options.appId],t,n,r).catch(e=>em.error(e))}let eF="@firebase/analytics",eR="0.10.0";(0,u.Xd)(new f.wA(ep,(e,{options:t})=>{let n=e.getProvider("app").getImmediate(),r=e.getProvider("installations-internal").getImmediate();return function(e,t,n){!function(){let e=[];if((0,h.ru)()&&e.push("This is a browser extension environment."),(0,h.zI)()||e.push("Cookies are not available."),e.length>0){let t=e.map((e,t)=>`(${t+1}) ${e}`).join(" "),n=eb.create("invalid-analytics-context",{errorInfo:t});em.warn(n.message)}}();let r=e.options.appId;if(!r)throw eb.create("no-app-id");if(!e.options.apiKey){if(e.options.measurementId)em.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw eb.create("no-api-key")}if(null!=eO[r])throw eb.create("already-exists",{id:r});if(!e$){var i,a;let e,t;e=[],Array.isArray(window[eN])?e=window[eN]:window[eN]=e;let{wrappedGtag:n,gtagCore:r}=(i="gtag",t=function(...e){window[eN].push(arguments)},window[i]&&"function"==typeof window[i]&&(t=window[i]),window[i]=(a=t,async function(e,...t){try{if("event"===e){let[e,n]=t;await eI(a,eO,ek,e,n)}else if("config"===e){let[e,n]=t;await ev(a,eO,ek,eM,e,n)}else if("consent"===e){let[e]=t;a("consent","update",e)}else if("get"===e){let[e,n,r]=t;a("get",e,n,r)}else if("set"===e){let[e]=t;a("set",e)}else a(e,...t)}catch(e){em.error(e)}}),{gtagCore:t,wrappedGtag:window[i]});l=n,s=r,e$=!0}eO[r]=eL(e,ek,eM,t,s,eN,n);let o=new eB(e);return o}(n,r,t)},"PUBLIC")),(0,u.Xd)(new f.wA("analytics-internal",function(e){try{let t=e.getProvider(ep).getImmediate();return{logEvent:(e,n,r)=>ex(t,e,n,r)}}catch(e){throw eb.create("interop-component-reg-failed",{reason:e})}},"PRIVATE")),(0,u.KN)(eF,eR),(0,u.KN)(eF,eR,"esm2017")},43464:function(e,t,n){"use strict";n.d(t,{ZF:function(){return r.ZF}});var r=n(54814);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
