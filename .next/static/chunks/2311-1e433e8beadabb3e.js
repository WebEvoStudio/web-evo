 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let z=new Map;function V(e,t){let n=H(e);Z(n,t),function(e,t){let n=(!W&&"BroadcastChannel"in self&&((W=new BroadcastChannel("[Firebase] FID Change")).onmessage=e=>{Z(e.data.key,e.data.fid)}),W);n&&n.postMessage({key:e,fid:t}),0===z.size&&W&&(W.close(),W=null)}(n,t)}function Z(e,t){let n=z.get(e);if(n)for(let e of n)e(t)}let W=null,q="firebase-installations-store",U=null;function K(){return U||(U=function(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){let o=indexedDB.open(e,1),s=I(o);return r&&o.addEventListener("upgradeneeded",e=>{r(I(o.result),e.oldVersion,e.newVersion,I(o.transaction))}),n&&o.addEventListener("blocked",()=>n()),s.then(e=>{a&&e.addEventListener("close",()=>a()),i&&e.addEventListener("versionchange",()=>i())}).catch(()=>{}),s}("firebase-installations-database",0,{upgrade:(e,t)=>{0===t&&e.createObjectStore(q)}})),U}async function G(e,t){let n=H(e),r=await K(),i=r.transaction(q,"readwrite"),a=i.objectStore(q),o=await a.get(n);return await a.put(t,n),await i.done,o&&o.fid===t.fid||V(e,t.fid),t}async function X(e){let t=H(e),n=await K(),r=n.transaction(q,"readwrite");await r.objectStore(q).delete(t),await r.done}async function J(e,t){let n=H(e),r=await K(),i=r.transaction(q,"readwrite"),a=i.objectStore(q),o=await a.get(n),s=t(o);return void 0===s?await a.delete(n):await a.put(s,n),await i.done,s&&(!o||o.fid!==s.fid)&&V(e,s.fid),s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
