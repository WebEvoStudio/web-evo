...
const pages = ["/Users/cityhunter/Documents/WorkSpace/web-evo/app/dashboard/blogs/[id]/modify/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/dashboard/blogs/[id]/modify/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/dashboard/blogs/[id]/modify/page",
        pathname: "/dashboard/blogs/[id]/modify",
...
/* __next_internal_client_entry_do_not_use__ ModifyBlog auto */ 




const ModifyBlog = ({ id })=>{
    const [blog, setBlog] = (0,react_.useState)({
        title: "",
        markContent: ""
    });
    (0,react_.useEffect)(()=>{
...
;// CONCATENATED MODULE: ./app/dashboard/blogs/[id]/modify/page.tsx
/* __next_internal_client_entry_do_not_use__ default auto */ 


const ModifyBlogPage = (props)=>{
    // console.log(props);
    const { params: { id } } = props;
    // const router = useRouter().query;
    console.log(id);
    return /*#__PURE__*/ jsx_runtime_.jsx(ModifyBlog, {
        id: id
    });
};
/* harmony default export */ const page = (ModifyBlogPage);
...
/* harmony export */ });
/* harmony import */ var next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18096);

const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/cityhunter/Documents/WorkSpace/web-evo/app/dashboard/blogs/[id]/modify/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [9900,4659,6162,2463,430,966,3576,1878,3251], () => (__webpack_exec__(83867)));
