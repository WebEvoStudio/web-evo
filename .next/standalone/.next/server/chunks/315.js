...
var deselectCurrent = __webpack_require__(78086);
...
// UNUSED EXPORTS: FirebaseError, SDK_VERSION, _DEFAULT_ENTRY_NAME, _addComponent, _addOrOverwriteComponent, _apps, _clearComponents, _components, _removeServiceInstance, deleteApp, getApps, onLog, setLogLevel

// EXTERNAL MODULE: ./node_modules/.pnpm/@firebase+component@0.6.4/node_modules/@firebase/component/dist/esm/index.esm2017.js
var index_esm2017 = __webpack_require__(86860);
// EXTERNAL MODULE: ./node_modules/.pnpm/@firebase+logger@0.4.0/node_modules/@firebase/logger/dist/esm/index.esm2017.js
var esm_index_esm2017 = __webpack_require__(11648);
// EXTERNAL MODULE: ./node_modules/.pnpm/@firebase+util@1.9.3/node_modules/@firebase/util/dist/node-esm/index.node.esm.js
var index_node_esm = __webpack_require__(38465);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@firebase+app@0.9.19/node_modules/@firebase/app/dist/esm/index.esm2017.js
...
/* harmony import */ var _firebase_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38465);
...
/* harmony export */ });
/* unused harmony exports LogLevel, setLogLevel, setUserLogHandler */
/**
 * @license
...
/* harmony export */   zI: () => (/* binding */ areCookiesEnabled)
/* harmony export */ });
/* unused harmony exports CONSTANTS, DecodeBase64StringError, MAX_VALUE_MILLIS, RANDOM_FACTOR, Sha1, assert, assertionError, async, base64, base64Decode, base64Encode, contains, createMockUserToken, createSubscribe, decode, deepCopy, deepExtend, errorPrefix, extractQuerystring, getDefaultEmulatorHost, getDefaultEmulatorHostnameAndPort, getDefaults, getExperimentalSetting, getGlobal, getUA, isAdmin, isBrowser, isElectron, isEmpty, isIE, isMobileCordova, isNode, isNodeSdk, isReactNative, isSafari, isUWP, isValidFormat, isValidTimestamp, issuedAtTime, jsonEval, map, ordinal, promiseWithTimeout, querystring, querystringDecode, safeGet, stringLength, stringToByteArray, stringify, uuidv4, validateArgCount, validateCallback, validateContextObject, validateNamespace */
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  IH: () => (/* reexport */ getAnalytics),
  Gb: () => (/* reexport */ isSupported),
  Kz: () => (/* reexport */ logEvent)
});

// UNUSED EXPORTS: getGoogleAnalyticsClientId, initializeAnalytics, setAnalyticsCollectionEnabled, setConsent, setCurrentScreen, setDefaultEventParameters, setUserId, setUserProperties, settings

// EXTERNAL MODULE: ./node_modules/.pnpm/@firebase+app@0.9.19/node_modules/@firebase/app/dist/esm/index.esm2017.js + 2 modules
var index_esm2017 = __webpack_require__(89985);
// EXTERNAL MODULE: ./node_modules/.pnpm/@firebase+logger@0.4.0/node_modules/@firebase/logger/dist/esm/index.esm2017.js
var esm_index_esm2017 = __webpack_require__(11648);
// EXTERNAL MODULE: ./node_modules/.pnpm/@firebase+util@1.9.3/node_modules/@firebase/util/dist/node-esm/index.node.esm.js
var index_node_esm = __webpack_require__(38465);
// EXTERNAL MODULE: ./node_modules/.pnpm/@firebase+component@0.6.4/node_modules/@firebase/component/dist/esm/index.esm2017.js
var dist_esm_index_esm2017 = __webpack_require__(86860);
;// CONCATENATED MODULE: ./node_modules/.pnpm/idb@7.0.1/node_modules/idb/build/wrap-idb-value.js
const instanceOfAny = (object, constructors) => constructors.some((c) => object instanceof c);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/idb@7.0.1/node_modules/idb/build/index.js
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/@firebase+installations@0.6.4_@firebase+app@0.9.19/node_modules/@firebase/installations/dist/esm/index.esm2017.js
...
const ERROR_FACTORY = new index_node_esm/* ErrorFactory */.LL(SERVICE, SERVICE_NAME, ERROR_DESCRIPTION_MAP);
/** Returns true if error is a FirebaseError that is based on an error from the server. */
function isServerError(error) {
    return (error instanceof index_node_esm/* FirebaseError */.ZR &&
...
const publicFactory = (container) => {
    ...
    const heartbeatServiceProvider = (0,index_esm2017/* _getProvider */.qX)(app, 'heartbeat');
...
const internalFactory = (container) => {
    ...
    const installations = (0,index_esm2017/* _getProvider */.qX)(app, INSTALLATIONS_NAME).getImmediate();
...
function registerInstallations() {
    (0,index_esm2017/* _registerComponent */.Xd)(new dist_esm_index_esm2017/* Component */.wA(INSTALLATIONS_NAME, publicFactory, "PUBLIC" /* ComponentType.PUBLIC */));
    (0,index_esm2017/* _registerComponent */.Xd)(new dist_esm_index_esm2017/* Component */.wA(INSTALLATIONS_NAME_INTERNAL, internalFactory, "PRIVATE" /* ComponentType.PRIVATE */));
}
...
(0,index_esm2017/* registerVersion */.KN)(index_esm2017_name, version);
// BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
(0,index_esm2017/* registerVersion */.KN)(index_esm2017_name, version, 'esm2017');


//# sourceMappingURL=index.esm2017.js.map

;// CONCATENATED MODULE: ./node_modules/.pnpm/@firebase+analytics@0.10.0_@firebase+app@0.9.19/node_modules/@firebase/analytics/dist/esm/index.esm2017.js
 ...
 * limitations under the License.
 */
const logger = new esm_index_esm2017/* Logger */.Yd('@firebase/analytics');
...
const index_esm2017_ERROR_FACTORY = new index_node_esm/* ErrorFactory */.LL('analytics', 'Analytics', ERRORS);
...
async function attemptFetchDynamicConfigWithRetry(appFields, { throttleEndTimeMillis, backoffCount }, signal, retryData = defaultRetryData // for testing
    ...
    try {
        ...
        const backoffMillis = Number((_a = error === null || error === void 0 ? void 0 : error.customData) === null || _a === void 0 ? void 0 : _a.httpStatus) === 503
            ? (0,index_node_esm/* calculateBackoffMillis */.$s)(backoffCount, retryData.intervalMillis, LONG_RETRY_FACTOR)
            : (0,index_node_esm/* calculateBackoffMillis */.$s)(backoffCount, retryData.intervalMillis);
...
function isRetriableError(e) {
    if (!(e instanceof index_node_esm/* FirebaseError */.ZR) || !e.customData) {
        return false;
    }
...
async function validateIndexedDB() {
    if (!(0,index_node_esm/* isIndexedDBAvailable */.hl)()) {
        ...
        try {
            await (0,index_node_esm/* validateIndexedDBOpenable */.eu)();
        }
        catch (e) {
            logger.warn(index_esm2017_ERROR_FACTORY.create("indexeddb-unavailable" /* AnalyticsError.INDEXEDDB_UNAVAILABLE */, {
...
function warnOnBrowserContextMismatch() {
    ...
    if ((0,index_node_esm/* isBrowserExtension */.ru)()) {
        mismatchedEnvMessages.push('This is a browser extension environment.');
    }
    if (!(0,index_node_esm/* areCookiesEnabled */.zI)()) {
 ...
 */
function getAnalytics(app = (0,index_esm2017/* getApp */.Mq)()) {
    app = (0,index_node_esm/* getModularInstance */.m9)(app);
    // Dependencies
    const analyticsProvider = (0,index_esm2017/* _getProvider */.qX)(app, ANALYTICS_TYPE);
...
function initializeAnalytics(app, options = {}) {
    ...
    if (analyticsProvider.isInitialized()) {
        ...
        if ((0,index_node_esm/* deepEqual */.vZ)(options, analyticsProvider.getOptions())) {
...
async function isSupported() {
    ...
    try {
        const isDBOpenable = await (0,index_node_esm/* validateIndexedDBOpenable */.eu)();
        return isDBOpenable;
    }
    catch (error) {
        return false;
...
function logEvent(analyticsInstance, eventName, eventParams, options) {
    analyticsInstance = (0,index_node_esm/* getModularInstance */.m9)(analyticsInstance);
...
const index_esm2017_version = "0.10.0";
...
function registerAnalytics() {
    (0,index_esm2017/* _registerComponent */.Xd)(new dist_esm_index_esm2017/* Component */.wA(ANALYTICS_TYPE, (container, { options: analyticsOptions }) => {
    ...
    (0,index_esm2017/* _registerComponent */.Xd)(new dist_esm_index_esm2017/* Component */.wA('analytics-internal', internalFactory, "PRIVATE" /* ComponentType.PRIVATE */));
    (0,index_esm2017/* registerVersion */.KN)(esm_index_esm2017_name, index_esm2017_version);
    // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
    (0,index_esm2017/* registerVersion */.KN)(esm_index_esm2017_name, index_esm2017_version, 'esm2017');
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/firebase@10.4.0/node_modules/firebase/analytics/dist/index.mjs
...
/* harmony export */ });
/* harmony import */ var _firebase_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(89985);
