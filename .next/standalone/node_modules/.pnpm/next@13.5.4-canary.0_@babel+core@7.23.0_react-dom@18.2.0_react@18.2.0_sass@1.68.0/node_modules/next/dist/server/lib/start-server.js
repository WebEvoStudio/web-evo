...
async function getRequestHandlers({ dir, port, isDev, server, hostname, minimalMode, isNodeDebugging, keepAliveTimeout, experimentalTestProxy }) {
...
function logStartInfo({ networkUrl, appUrl, hostname, envInfo, expFeatureInfo, formatDurationText }) {
    _log.bootstrap(_chalk.default.bold(_chalk.default.hex("#ad7fa8")(`${`${_log.prefixes.ready} Next.js`} ${"13.5.4-canary.0"}`)));
